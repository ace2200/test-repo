...
#dictionary compreshenion to insert values of zero
count_dict = {i:0 for i in names}

#get number from user to execute random number of time a name to be picked
...
while choose:
        ...
        #if value of choose is equal to number given the program will end
